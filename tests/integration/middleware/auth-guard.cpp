// tests/integration/middleware/auth-guard.cpp
//
// Integration test: middleware implementing auth guard pattern.
...
TEST_CASE("Middleware: auth guard middleware", "[middleware][integration]")
{
