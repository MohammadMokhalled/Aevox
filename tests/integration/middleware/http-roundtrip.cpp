// tests/integration/middleware/http-roundtrip.cpp
//
// Integration test: middleware with real router dispatch.
// Verifies middleware can modify responses.
...
TEST_CASE("Middleware: HTTP roundtrip with middleware adding response header",
