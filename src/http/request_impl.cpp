...
template std::expected<int, ParamError> Request::param<int>(std::string_view) const noexcept;

template std::expected<long, ParamError> Request::param<long>(std::string_view) const noexcept;

template std::expected<double, ParamError> Request::param<double>(std::string_view) const noexcept;

template std::expected<std::string, ParamError> Request::param<std::string>(
    std::string_view) const noexcept;

template std::expected<std::string_view, ParamError> Request::param<std::string_view>(
    std::string_view) const noexcept;
