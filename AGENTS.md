# AGENTS.md — Aevox Framework AI Rules
...
│   ├── {header}.hpp        ← one per public module / class
│   └── {module}/           ← sub-module headers if needed
...
│   └── BACKLOG.md
├── ProductRequirement/
│   └── {prd-name}.md       ← SOURCE OF TRUTH — read before deciding anything
├── CMakeLists.txt
├── vcpkg.json
